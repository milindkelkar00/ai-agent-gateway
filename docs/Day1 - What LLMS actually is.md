...
Who decides the role? We do - it's just the label saying "this message cmae from the human" (user) vs "this text was previously generated by the model" (assistant)
